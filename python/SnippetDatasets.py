...
class SnippetDatasets:
    ...
    def save_content_translated_with_original(self, ds_id, pandas_df, epoche=None):
        ...
        if git_directory:
            ...
            if is_new:
                ...
                os.system(f"cd ${self.git_view_path}; git add '${git_directory}'")
            ...
            if is_new:
                os.system(f"cd ${self.git_view_path}; git add '${git_directory}/content-translated-with_original.csv'")
    ...
    def save_word_error_rate(self, ds_id, epoche, wer):
        ...
        if git_directory:
            ...
            git_view_path = self.git_repository
            # !cd $git_view_path; git commit -am '$git_comment'
            os.system(f"cd ${self.git_view_path}; git commit -am '${git_comment}'")
        else:
            ds_directory = self._get_directory(ds_id)
